                ...
                <div class="container">
					...
					if (!isset($_SESSION['id'])){ ?>
						  ...
						  <li class="divider-vertical"></li>
								...
								<li class="divider-vertical"></li>
								<li class="">
								<a  rel="tooltip"  data-placement="bottom" title="Admin" id="home"   href="http://localhost/aplikasi/STI/registrar/"><i class="icon-home icon-large"></i>&nbsp;Admin</a> 
								</li>
					...
					<li><a href="view_student.php"><i class="icon-signout icon-large"></i>&nbsp;View Profile</a></li>
