				...
				<div class="span10">
		          ...
		          <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">                      
                        ...
                        <tbody>
                            ...
                            $result = mysql_query("SELECT sum(gen_ave) FROM grade  where student_id = '$session_id' and school_year like '%$school_year%' and semester like '%$semester%'") or die(mysql_error());
                            
							
							
							
							$test_count=mysql_query("select * from grade where gen_ave <> '' and student_id = '$session_id' and school_year like '%$school_year%' and semester like '%$semester%' ")or die(mysql_error());
