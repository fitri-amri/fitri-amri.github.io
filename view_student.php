...
<?php $student_id = $_GET['student_id']; ?>
	...
	<form class="form-horizontal" method="POST" action="update_students.php" enctype="multipart/form-data">
		...
		<div class="control-group">
			...
			<div class="controls">
			<input type="text" id="inputEmail" name="firstname" value="<?php echo $row['firstname']; ?>" placeholder="Firstname" readonly required>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="inputPassword">Lastname:</label>
			<div class="controls">
			<input type="text" id="inputPassword" name="lastname" value="<?php echo $row['lastname']; ?>" placeholder="Lastname" readonly required>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
			<input type="text" id="inputPassword" name="icnumber" value="<?php echo $row['icnumber']; ?>" placeholder="IC Number" readonly required>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
			<input type="text" id="inputPassword" name="gender" value="<?php echo $row['gender']; ?>"  readonly required>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
			<select name="muet" readonly required>
		...
		<div class="control-group">
			...
			<div class="controls">
			<select name="fees" readonly required>
		...
		<div class="control-group">
			...
			<div class="controls">
			<select name="course" readonly required class="span2">
		...
		<div class="control-group">
			...
			<div class="controls">
				<select name="year_level" readonly required>
	...
	<?php 
		...
		<div class="control-group">
			...
			<div class="controls">
					<select name="term" class="span2" readonly required>
		...
		<div class="control-group">
			...
			<div class="controls">
					<select name="status" class="span2" readonly required>
